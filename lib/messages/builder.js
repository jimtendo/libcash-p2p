...
function builder(options) {
  ...
  if (!options.network) {
    options.network = libcash.Networks.defaultNetwork;
  }

  options.Block = options.Block || libcash.Block;
  options.BlockHeader = options.BlockHeader || libcash.BlockHeader;
  options.Transaction = options.Transaction || libcash.Transaction;
  options.MerkleBlock = options.MerkleBlock || libcash.MerkleBlock;
